 ...
 */
public class Pila extends JLabel{
     ...
     */
    private Pila(int x , int y , int width , int height , int jobNumber)
    {
     ...
     * @return 
     */
    public static Pila createGanttCell(int x , int y , int jobNumber) 
    {
        return new Pila(x, y, 10, 80, jobNumber);
    }
     ...
     * @param y y-coordinate location of the Cell 
     */
    public static Pila createEmptyJobCell(int x , int y)
    {
        return new Pila(x,y,10,10,9);
    }
     ...
     * @return Cell
     */
    public static Pila createReadyColaCell(int x , int y , int jobNumber)
    {
        return new Pila(x,y, 36 , 80 ,jobNumber);
    }
     ...
     * @return Cell
     */
    public static Pila createMark(int x , int y)
    {
        return new Pila(x,y,1,10,10);
    }
