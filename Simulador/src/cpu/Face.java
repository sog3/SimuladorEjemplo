...
import Info.AcercaDe;
import Info.Instruccion;
import Items.Pila;
import Items.Job;
...
public class Face extends javax.swing.JFrame {
     ...
     */
    private void viewVisuals(Job job , Cola readyQueue)
    {
     ...
     */
    private void addToGUI (ArrayList<Pila> list)
    {
     ...
     */
    private void removeFromGUI ( ArrayList<Pila> list)
    {
        for(int i =0 ; i< list.size() ; i++)
        {
           remove(list.get(i)); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Numero de trabajos");
        ...
        anotherSimBttn.setText("Comienzar otra simulación");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(simSpeed, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        cpuPanel.setBorder(javax.swing.BorderFactory.createBevelBorder(0));
        ...
        Average.setBorder(javax.swing.BorderFactory.createBevelBorder(0));
    ...
    */
    private void nextStepBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextStepBttnActionPerformed
        ...
        if(!Simulation.Finished)
        {
            ...
            viewVisuals(job, Simulation.getReadyCola());
        }
